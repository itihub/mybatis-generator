...
public class BatchUpsertMethodGenerator extends AbstractJavaMapperMethodGenerator {

    private static final String STATEMENT_ID = "batchUpsert";

    private final boolean isSimple;

    public BatchUpsertMethodGenerator(boolean isSimple) {
        super();
    ...
    public void addInterfaceElements(Interface interfaze) {
        ...
        method.addParameter(new Parameter(parameterType, "rows")); //$NON-NLS-1$
