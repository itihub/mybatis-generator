...
public class BatchUpsertSelectiveMethodGenerator extends AbstractJavaMapperMethodGenerator {

    private static final String STATEMENT_ID = "batchUpsertSelective";

    public BatchUpsertSelectiveMethodGenerator() {
        super();
    }
    ...
    public void addInterfaceElements(Interface interfaze) {
        ...
        method.addParameter(new Parameter(parameterType, "rows", "@Param(\"rows\")")); //$NON-NLS-1$
