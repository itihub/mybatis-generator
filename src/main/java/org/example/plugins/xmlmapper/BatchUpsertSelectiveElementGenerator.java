...
public class BatchUpsertSelectiveElementGenerator extends AbstractXmlElementGenerator {
    ...
    public void addElements(XmlElement parentElement) {
        ...
        for (int i = 0; i < introspectedColumns.size(); i++) {
            ...
            if (sb.length() > 80) {
                conflictClauses.add(sb.toString());
        ...
        XmlElement upsertElement = new XmlElement("set");
        answer.addElement(upsertElement);
        ...
        for (IntrospectedColumn introspectedColumn :
            ...
            XmlElement upsertNotNullElement = new XmlElement("if");
            ...
            sb.append(introspectedColumn.getActualColumnName());
            sb.append(',');
            upsertNotNullElement.addElement(new TextElement(sb.toString()));
            upsertElement.addElement(upsertNotNullElement);
        }
