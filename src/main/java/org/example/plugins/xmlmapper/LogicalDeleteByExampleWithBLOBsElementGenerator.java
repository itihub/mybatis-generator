...
public class LogicalDeleteByExampleWithBLOBsElementGenerator extends AbstractXmlElementGenerator {
    ...
    public LogicalDeleteByExampleWithBLOBsElementGenerator(String statementId, String logicalDeleteColumnName,
